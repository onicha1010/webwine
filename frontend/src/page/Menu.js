...
import { fevCartItem } from "../redux/productSlide";
...
const Menu = () => {
  ...
  const handleFavorite = (e) =>{
    dispatch(fevCartItem(productDisplay))
  };
  ...
  return (
    <div className="p-2 md:p-4">
      <div className="w-full max-w-4xl m-auto md:flex bg-white">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-between">
            ...
            {/* <div className="text-3xl cursor-pointer text-slate-700 hover:text-red-500 ">
              <AiFillHeart/>
            </div> */}
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button onClick={handleFavorite} className="text-3xl cursor-pointer text-slate-700 hover:text-red-500"><AiFillHeart/></button>
          </div>
          <div>
      ...
      <AllProduct heading={"Related Wine"}/>
    </div>
  )
}
