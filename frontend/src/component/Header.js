        ...
        <div className='flex items-center h-full justify-between'>
            ...
            <div className='flex items-center gap-4 md:gap-7'>
                <nav className='gap-4 md:gap-6 text-base md:text-lg hidden md:flex'>
                    <Link to={""}>Home</Link>
                    <Link to={"menu/647f131e7c3b09330e5efcc1"}>Wine</Link>
                ...
                <div className='text-slate-600 ' onClick={handleShowMenu}>
                    ...
                    { showMenu && (
                        <div className='absolute right-2 bg-white py-2 shadow drop-shadow-md flex flex-col'>
                            ...
                            {
                                userData.image &&  <Link to={"profile/647af14fb3991113185f2f48"} className='whitespace-nowrap cursor-pointer px-2'>({userData.firstName}) Profile</Link>  
                            }
                            {
                            ...
                            <nav className="text-base md:text-lg flex flex-col md:hidden">
                                ...
                                <Link to={"menu/647f131e7c3b09330e5efcc1"} className="px-2 py-1">Wine</Link>
                                <Link to={"request"} className="px-2 py-1">Request</Link>
                            </nav>
                        </div>
                    )}   
                </div>
